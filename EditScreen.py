...
class EditScreen(MDScreen):
    ...
    def save(self, instance):
        ...
        try:
            if self.goal.text[0] == '0':  # Remove excessive zeros from the input, eg. 007 --> 7
            ...
            elif self.habit_name.text == habits[fetch_index()].name and [habit.name for habit in habits].count(self.habit_name.text) > 1:
